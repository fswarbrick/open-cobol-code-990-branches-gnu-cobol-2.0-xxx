...
pkgdatadir = $(datadir)/gnu-cobol
pkgincludedir = $(includedir)/gnu-cobol
pkglibdir = $(libdir)/gnu-cobol
pkglibexecdir = $(libexecdir)/gnu-cobol
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = x86_64-apple-darwin12.6.0
host_triplet = x86_64-apple-darwin12.6.0
subdir = .
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	$(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in $(top_srcdir)/build_aux/mkinstalldirs \
	ABOUT-NLS $(include_HEADERS) COPYING COPYING.DOC \
	COPYING.LESSER build_aux/ChangeLog THANKS TODO \
	build_aux/compile build_aux/config.guess \
	build_aux/config.rpath build_aux/config.sub build_aux/depcomp \
	build_aux/install-sh build_aux/mdate-sh build_aux/missing \
	build_aux/mkinstalldirs build_aux/ltmain.sh \
...
ACLOCAL = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/missing automake-1.13
AWK = awk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/missing makeinfo
MANIFEST_TOOL = :
...
abs_builddir = /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0
abs_srcdir = /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0
abs_top_builddir = /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0
abs_top_srcdir = /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Users/Frank/open-cobol-code-990-branches-gnu-cobol-2.0/build_aux/install-sh
...
SUBDIRS_PREREQUISITES = libcob lib cobc bin config copy extras
SUBDIRS = libcob lib cobc bin config copy po doc extras tests
ACLOCAL_AMFLAGS = -I m4 --install
BUILT_SOURCES = defaults.h
DISTCLEANFILES = $(BUILT_SOURCES)
# CLEANFILES = $(bin_SCRIPTS)
EXTRA_DIST = gnu-cobol.spec po/en.translate \
	lib/Makefile.am lib/ChangeLog lib/dummymac.c lib/gettext.h
...
dist-hook:
	...
	chmod 644 $(distdir)/gnu-cobol.spec
...
defaults.h: Makefile.am $(top_builddir)/config.status
	...
	@{								\
	  ...
	  echo "#define COB_OBJECT_EXT   \"$(COB_OBJECT_EXT)\"";	\
